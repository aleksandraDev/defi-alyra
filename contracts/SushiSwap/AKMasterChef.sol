...
contract AKMasterChef is Ownable {
    ...
    IAKMigratorChef public migrator;
    // Info of each pool.
    ...
    function setMigrator(IAKMigratorChef _migrator) public onlyOwner {
        migrator = _migrator;
    }
